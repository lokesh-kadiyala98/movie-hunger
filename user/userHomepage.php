                        ...
                        if(mysqli_num_rows($movieSuggestions)) {
                          foreach ($movieSuggestions as $row) {
                            ...
                            if($directorName != $nextDirectorName) {
                              ...
                              echo '<div class="display-4 text-light">'.$directorName.'\'s movies you may like</div>';
                              echo '<h5 class="lato mb-2 text-secondary">Based on your ratings.</h5>';
                              echo '<a href="userView.php?movieId='.$row['movieId'].'"><img style="width: 100px;" class="mr-3 mb-2 align-self-center" src="../images/posters/'.$row['title'].'(main).jpg"></a>';
